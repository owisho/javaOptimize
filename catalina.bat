...
set CATALINA_OPTS=%CATALINA_OPTS% "-XX:ParallelCMSThreads=2"
set CATALINA_OPTS=%CATALINA_OPTS% "-XX:+UseCMSCompactAtFullCollection" 
rem log mechanism
set CATALINA_OPTS=%CATALINA_OPTS% "-Xloggc:gc.log"
set CATALINA_OPTS=%CATALINA_OPTS% "-verbose:gc"
set CATALINA_OPTS=%CATALINA_OPTS% "-XX:+PrintGCDateStamps" 
set CATALINA_OPTS=%CATALINA_OPTS% "-XX:+PrintGCTimeStamps" 
set CATALINA_OPTS=%CATALINA_OPTS% "-XX:+PrintGCDetails" 
set CATALINA_OPTS=%CATALINA_OPTS% "-XX:+PrintHeapAtGC" 
set CATALINA_OPTS=%CATALINA_OPTS% "-Xloggc:tomcat7062gc.log" 
